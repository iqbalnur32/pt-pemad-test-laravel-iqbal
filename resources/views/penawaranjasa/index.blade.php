...
@section('page_title', 'Penawaran Jasa')
@section('page_subtitle', 'My Penawaran Jasa Dashboard')
...
<div class="row">
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <form action="{{route('penawaranjasa.destroy', $val->id)}}" method="post">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="updateUsers">Penawaran Jasa Edit</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <form action="{{ route('penawaranjasa.update', $val->id) }}" method="POST">
                      {{ method_field('PUT') }}
                      @csrf
                      <div class="modal-body">
                        <div class="form-group">
                          <label for="recipient-name" class="col-form-label">Harga:</label>
                          <input type="number" class="form-control" name="harga" value="{{ $val->harga }}">
                        </div>
                        <div class="form-group">
  ...
  <div class="modal fade" id="addProyek" tabindex="-1" role="dialog" aria-labelledby="addProyek" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addProyek">Penawaran Jasa Add</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="{{ route('penawaranjasa.store') }}" method="POST">
          @csrf
          <div class="modal-body">
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">Harga:</label>
