...
@section('page_title', 'Pekerjaan')
@section('page_subtitle', 'My Pekerjaan Dashboard')
...
<div class="row">
        ...
        <div class="table-responsive">
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      <button data-toggle="modal" data-target="#editPekerjaan{{ $val->id }}" class="dropdown-item" href="">Edit</button>
                      <form action="{{route('pekerjaan.destroy', $val->id)}}" method="post">
              ...
              <!-- Modal Edit -->
              <div class="modal fade" id="editPekerjaan{{ $val->id }}" tabindex="-1" role="dialog" aria-labelledby="updateUsers" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="updateUsers">Pekerjaan Add</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <form action="{{ route('pekerjaan.update', $val->id) }}" method="POST">
                      {{ method_field('PUT') }}
                      @csrf
  ...
  <div class="modal fade" id="addKlien" tabindex="-1" role="dialog" aria-labelledby="addKlien" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addKlien">Pekerjaan Add</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="{{ route('pekerjaan.store') }}" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">Tipe Pekerjaan:</label>
              <select name="id_tipe_pekerjaan" class="form-control" id="" required>
                @foreach ($tipekerjaan as $val2)
